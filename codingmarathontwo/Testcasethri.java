...
public class Testcasethri {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("(//div[contains(@class,'roleMenu-item ')])[2]")).click();

		List<WebElement> certificationlist = driver.findElements(By.xpath(
				"//h1[text()='Salesforce Architect Credentials']//following::div[@class='credentials-card ']//div[@class='credentials-card_title']"));

		System.out.println("Architect Certifications");
		for (WebElement lst : certificationlist) {
